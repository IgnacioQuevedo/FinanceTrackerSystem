...
public class ReportTests
{
    ...
    {
        CreditCardAccount credit = new CreditCardAccount("My Credits", CurrencyEnum.UY, DateTime.Now, "Brou", "1234",
            1000, DateTime.Now);

        Transaction myTransaction = new Transaction("Payment for party", 200, DateTime.Now.Date, CurrencyEnum.UY,
            TypeEnum.Outcome, genericCategory2);

        Transaction myTransaction2 = new Transaction("Payment for FOOD", 100, new DateTime(2023, 9, 9), CurrencyEnum.UY,
            TypeEnum.Outcome, genericCategory);
