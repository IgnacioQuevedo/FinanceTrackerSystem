    ...
    public static CreditCardAccount ToCreditAccount(CreditCardAccountDTO myCreditAccountDTO)
    {
        try
        {
            CreditCardAccount creditAccount =
              new CreditCardAccount(myCreditAccountDTO.Name, (CurrencyEnum)myCreditAccountDTO.Currency,myCreditAccountDTO.CreationDate, myCreditAccountDTO.IssuingBank, myCreditAccountDTO.Last4Digits, myCreditAccountDTO.AvailableCredit, myCreditAccountDTO.ClosingDate);
